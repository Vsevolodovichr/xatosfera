...
const translations = {
  uk: {
    ...
    'dashboard.totalCommission': 'Загальна комісія',
    ...
    'reports.totalCommission': 'Сума комісії',
  ...
  en: {
    ...
    'properties.commission': 'Commission',
    ...
    'reports.totalCommission': 'Commission Total',
