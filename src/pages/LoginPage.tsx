        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <div className="mt-12 grid grid-cols-3 gap-6">
            <div className="text-center p-4 rounded-xl bg-white/5 backdrop-blur">
              ...
              <div className="text-sm text-white/60">{t('auth.stats_properties')}</div>
            </div>
            <div className="text-center p-4 rounded-xl bg-white/5 backdrop-blur">
              <div className="text-3xl font-bold text-accent">50+</div>
              <div className="text-sm text-white/60">{t('auth.stats_deals')}</div>
            </div>
            <div className="text-center p-4 rounded-xl bg-white/5 backdrop-blur">
              <div className="text-3xl font-bold text-accent">₴2M+</div>
              <div className="text-sm text-white/60">{t('auth.stats_volume')}</div>
            </div>
          </div>
        </div>
      </div>
